...
public class RecipeIngredient extends AppCompatActivity {
    ...
    private DatabaseReference rrDatabase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rrDatabase = FirebaseDatabase.getInstance().getReference();
        rrDatabase.child("recipe").child(recipe_num).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                cookbutton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("recipe_num", Integer.parseInt(recipe_num));
